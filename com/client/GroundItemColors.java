...
public class GroundItemColors implements Serializable {
	...
	public static void saveGroundItems(ArrayList<GroundItemColors> itemColors) {
		try {
			...
			File file = new File(Signlink.findCacheDir() + "grounditems.ser");
			FileOutputStream fileOut = new FileOutputStream(Signlink.findCacheDir() + "grounditems.ser");
	...
	public static void loadGroundItems() {
		...
		try {
			FileInputStream fileIn = new FileInputStream(Signlink.findCacheDir() + "grounditems.ser");
